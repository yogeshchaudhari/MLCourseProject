...
dnn_md4.epoch = 40
dnn_md4.MAX_STEPS = [dnn_md4.epoch, dnn_md4.epoch, dnn_md4.epoch, dnn_md4.epoch, dnn_md4.epoch, dnn_md4.epoch,
                     dnn_md4.epoch, dnn_md4.epoch, dnn_md4.epoch, dnn_md4.epoch]
...
if os.path.exists(dnn_md4.Kfold):
    kf1 = pickle.load(open(dnn_md4.Kfold,"rb"))
...
name = dnn_md1.name + '_' + str(dnn_md1.hidden_units[0]) + '-' + str(dnn_md1.hidden_units[1]) + '-' + str(
    dnn_md1.hidden_units[2]) + '-' + str(dnn_md1.hidden_units[3]) + '_' + str(dnn_md1.alpha) + '_' + str(
    dnn_md1.beta) + '_' + str(dnn_md1.gamma)
# SCORE
